...
Always conclude the discussion with a very short summary:
...
If the user explicitly requests a full summary or a handoff, include the following additional sections:
...
- **Technical details** - capture any technical details that were discovered during the discussion that are relevant to the implementation, but not part of the requirements.
